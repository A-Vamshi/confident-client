...
export class OrganizationOperations {
   ...
   * endpoint operates inside this organization, so its `id` is the one to pass
   ...
   * field this endpoint changes — the plan follows your subscription and cannot
  ...
  async updateModelCredentials(
    ...
    return this.api.sendRequest<ModelCredentials>(
      ...
      { body: { provider, apiKey, modelConfig } },
    );
  }
